                    ...
                    <div class="row">
                        <div class="col-lg-8 mb-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="password2" class="form-control" id="password2" placeholder="konfirmasikan password anda" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select name="level" id="level" class="form-control" required>
                                    ...
                                    <option value="2">Pramuniaga/ri</option>
                                    <option value="3">Karyawan</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <label for="alamat">Alamat</label>
                                <textarea name="alamat" id="alamat" cols="" rows="3" class="form-control" placeholder="Masukkan alamat mu" required></textarea>
                            </div>
                        </div>
                        <div class="col-lg-4 text-center">
                            <img src="<?= $main_url ?>asset/image/download.png" class="profile-user-img img-circle mb-3" alt="">
